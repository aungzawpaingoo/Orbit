  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container w-full px-5 py-24 mx-auto flex flex-wrap flex-col">
        ...
        <img className="w-full block mx-auto mb-10 object-cover object-center rounded" alt="project management" src="https://dummyimage.com/1920x1080" />
        
        <div className="flex flex-col text-center w-full">
          <h1 className="text-xl font-medium title-font mb-4 text-gray-900">Effortlessly Manage Projects with Orbit</h1>
