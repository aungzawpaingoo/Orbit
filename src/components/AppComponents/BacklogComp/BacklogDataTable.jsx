...
//   Button,
// } from '@mui/material';
// import { KeyboardArrowDown as KeyboardArrowDownIcon, KeyboardArrowUp as KeyboardArrowUpIcon, Delete as DeleteIcon, Edit as EditIcon } from '@mui/icons-material';

// const BacklogDataTable = ({ tasks, deleteTask, updateTask }) => {
//   const [open, setOpen] = React.useState(null); // To manage which task's details are shown
...
//     const updatedTask = { ...task, status: task.status === 'Todo' ? 'In Progress' : 'Todo' };
...
//               <TableRow>
//                 <TableCell>
//                   <IconButton size="small" onClick={() => setOpen(open === task.id ? null : task.id)}>
//                     {open === task.id ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
//                   </IconButton>
//                 </TableCell>
//                 <TableCell>{task.name}</TableCell>
...
//                 <TableCell>
//                   <IconButton onClick={() => handleUpdate(task)} color="primary">
//                     <EditIcon />
//                   </IconButton>
