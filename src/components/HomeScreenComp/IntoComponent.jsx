...
// const IntoComponent = () => {
//   return (
//     <div className="flex flex-col lg:flex-row justify-between items-center p-6 lg:p-12 w-full h-full relative">
...
//         }}
//       >
//         {/* Overlay to control transparency of the background image */}
//         <div
//           className="absolute inset-0 bg-black"
//           style={{
//             opacity: 0.5, // Adjust opacity of the background image here
//           }}
//         ></div>
//       </div>

//       {/* Content */}
//       <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center w-full h-full">
//         <div className="text-center lg:text-left mb-6 lg:mb-0 lg:w-1/2">
//           <h1 className="text-4xl lg:text-5xl font-bold mb-4 text-white">Great outcomes</h1>
//           <h2 className="text-2xl lg:text-3xl mb-6 text-white">start with Orbit</h2>
