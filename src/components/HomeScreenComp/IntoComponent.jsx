  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center p-6 lg:p-24 bg-white w-full h-full">
      <div className="text-center lg:text-left mb-6 lg:mb-0 lg:w-1/2">
        <h1 className="text-5xl lg:text-6xl font-bold mb-4">Great outcomes</h1>
        <h2 className="text-2xl lg:text-3xl mb-6 ml-1 font-bold">
          start with{' '}
          <span className="text-blue-500 font-extrabold text-6xl lg:text-7xl">Orbit</span>
        </h2>
      ...
      <div className="bg-white shadow-lg p-6 rounded-lg w-full max-w-md lg:w-1/3">
        ...
        <div className="flex justify-center space-x-4">
          <button
            className="flex items-center justify-center w-full px-4 py-2 bg-white hover:bg-gray-100 border border-gray-300 rounded"
